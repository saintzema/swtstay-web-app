        ...
        <ul class="flex flex-wrap -mb-px">
            <li class="me-2">
                <a href="{{ route('user.settings.profile') }}" wire:navigate
                    class="inline-block p-4  rounded-t-lg {{ request()->url() === route('user.settings.profile') ? 'text-primary-500 border-b-2 border-primary-500' : 'hover:text-gray-600 hover:border-gray-300 border-b-2 border-transparent' }}">
                    Profile
                </a>
            </li>
