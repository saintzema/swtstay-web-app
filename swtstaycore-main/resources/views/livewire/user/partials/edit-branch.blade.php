            ...
            <div>
                ...
                <select id="country" wire:model.live="country"
                    ...
                    @foreach ($countries as $country)
                        <option value="{{ $country->name }}" {{ $country->name == $this->country ? 'selected' : '' }}>
                            {{ $country->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select id="state" wire:model.live="state"
                   ...
                   @foreach ($states as $state)
                        <option value="{{ $state->name }}" {{ $state->name == $this->state ? 'selected' : '' }}>
                            {{ $state->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select id="city" wire:model="city"
                    ...
                    @foreach ($cities as $city)
                        <option value="{{ $city->name }}" {{ $city->name == $this->city ? 'selected' : '' }}>
                            {{ $city->name }}
                        </option>
                    @endforeach
                </select>
